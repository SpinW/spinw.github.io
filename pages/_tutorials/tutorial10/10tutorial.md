...
be used instead! 
</pre> <img vspace="5" hspace="5" src="/tutorial10_02.png" alt=""> <h2 id="2">Spin wave</h2><p>We need to define a grid in reciprocal space, here we use the (Qh, Qk, 0) square lattice plane by calling ndgrid() function.</p><pre class="codeinput">nQ = 201;
nE = 501;
Qhv = linspace(0,2,nQ);
Qkv = linspace(0,2,nQ);
Qlv = 0;
