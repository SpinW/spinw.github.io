...
be used instead! If you don't want to see this message add a line to xrayion.dat
(use the 'edit xrayion.dat' command) for the corresponding ion! 
</pre> <img vspace="5" hspace="5" src="/tutorial14_02.png" alt=""> <h2 id="2">Magnetic Hamiltonian</h2><p>The exchange constants are taken from the paper.</p><pre class="codeinput">Jab   = 2.6;
Jc    = 3.1;
delta = 0.35;
K1    = 0.90;
K2    = 0.97;
