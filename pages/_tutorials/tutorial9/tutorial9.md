...
plot(DMkag,
  ...
  <img vspace="5" hspace="5" src="/tutorial9_03.png" style="width:560px;height:420px;" alt="">
  <h2 id="4">
   Calculate spin wave dispersion
  </h2>
  <pre class="codeinput">
   Qlist = {[-1/2 0 0] [0 0 0] [1/2 1/2 0] 100};
dmkSpec = DMkag.spinwave(Qlist,
   <span class="string">
    'hermit'
   </span>
   ,false);
...
sw_plotspec(dmkSpec,
  ...
  <img vspace="5" hspace="5" src="/tutorial9_04.png" style="width:560px;height:420px;" alt="">
  <h2 id="5">
   Powder spectrum
  </h2>
  <p>
  ...
  <pre class="codeinput">
   dmkPow = DMkag.powspec(linspace(0,2.5,150),
   <span class="string">
    'Evect'
   </span>
   ,linspace(0,3,250),
