...
Ground state energy: -1.630 meV/spin.
  ...
  <img vspace="5" hspace="5" src="/tutorial6_03.png" style="width:560px;height:420px;" alt="">
  <h2 id="4">
   Spin wave dispersion
  </h2>
  <pre class="codeinput">
...
kag4Spec = sw_egrid(kag4Spec,
   <span class="string">
    'Evect'
   </span>
   ,linspace(0,6.5,100)) ;
figure
sw_plotspec(kag4Spec,
   <span class="string">
    'mode'
   </span>
   ,1,
...
added to its diagonal!
  ...
  <img vspace="5" hspace="5" src="/tutorial6_04.png" style="width:560px;height:420px;" alt="">
  <h2 id="5">
   Powder averaged spectrum
  </h2>
  <pre class="codeinput">
   kag4Pow = kagome4.powspec(linspace(0,2.5,100),
   <span class="string">
    'Evect'
   </span>
   ,linspace(0,7,250),
