...
plot(banb,
  ...
  <img vspace="5" hspace="5" src="/tutorial15_01.png" style="width:560px;height:420px;" alt="">
  <h2 id="2">
   Chrality
  </h2>
  <p>
...
swplot.zoom(1.3)
  ...
  <p>
   ...
   =(0,0,e_H*1/7), the spins are lying in the
   <b>
    ab
   </b>
   -plane and we use a single cell to describe the structure (default value of nExt = [1 1 1]). We plot the triangular plane magnetic structure.
  </p>
  <pre class="codeinput">
...
E1 = banb.energy;
  ...
  <img vspace="5" hspace="5" src="/tutorial15_03.png" style="width:560px;height:420px;" alt="">
  <h2 id="5">
   Alternatively we optimize the magnetic structure
  </h2>
  <p>
...
colormap(jet)
  ...
  <p>
   We plot the imaginary part of the spin-spin correlation function: Myz-Mzy that are components in the Q coordinate system, this agrees well with Fig. 5 of PRL
   <b>
    106
   </b>
   , 207201 (2011).
...
colormap(makecolormap([0 1 0],[1 1 1],[0 0 1],81));
  ...
  <img vspace="5" hspace="5" src="/tutorial15_05.png" style="width:560px;height:420px;" alt="">
  <pre>
   Written by
Sandor Toth
