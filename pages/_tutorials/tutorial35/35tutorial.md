...
layout: tutorial
title: Tutorial 35
subtitle: Crystal structure of LuVO3
---

<div class="content"><h1>Crystal structure of LuVO3</h1><!--introduction--><p>We generate crystal structure of LuVO3 including the non-magnetic atoms and using a non-standard space-group setting of Pnma.</p><!--/introduction--><h2>Contents</h2><div><ul><li><a href="#1">Define the lattice</a></li><li><a href="#2">Generate Hamiltonian</a></li><li><a href="#3">Plot crystal structure with octahedral environment</a></li><li><a href="#4">Direct input of the magnetic structure</a></li><li><a href="#5">Check out matparser that can change the matrices in a spinw object</a></li><li><a href="#6">Fit experimental spin wave dispersion</a></li><li><a href="#7">Check the calculated spin wave spectrum</a></li></ul></div><h2 id="1">Define the lattice</h2><pre class="codeinput">luvo = spinw;
...
luvo.plot
</pre> <img vspace="5" hspace="5" src="/tutorial35_02.png" alt=""> <h2 id="2">Generate Hamiltonian</h2><p>We generate the spin Hamiltonian.</p><pre class="codeinput">luvo.gencoupling
...
swplot.transform(R)
swplot.translate
</pre><img vspace="5" hspace="5" src="/tutorial35_03.png" alt=""> <h2 id="4">Direct input of the magnetic structure</h2><p>We input directly the antiferromagnetic structure.</p><pre class="codeinput">luvo.genmagstr(<span class="string">'mode'</span>,<span class="string">'helical'</span>,<span class="string">'S'</span>,[0 0 1]',<span class="string">'n'</span>,[0 1 0],<span class="string">'k'</span>,[0 1 1]);

<span class="comment">% Overplot the magnetic structure without replotting the crystal</span>
swplot.plotmag
</pre><img vspace="5" hspace="5" src="/tutorial35_04.png" alt=""> <h2 id="5">Check out matparser that can change the matrices in a spinw object</h2><p>We will use the spinw.matparser mothod to parameterize the Hamiltonian. These will be out fitting parameters later. After calling matparser, we can check the resulting matrices using the spinw.table method.</p><pre class="codeinput">x1 = [4.24 5.95 -0.46 -0.48];
